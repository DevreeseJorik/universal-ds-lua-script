...
function LoadLines:displayLoadLines()
    ...
    Display:drawLineCentered(0,relativePosY*13-8,Display.width,0,self.loadLineColor,0,1)
end 
...
function LoadLines:displayMapLines()
    ...
    Display:drawLineCentered(0,relativePosY*13-8,Display.width,0,self.mapLineColor,0,1)
end 
...
function LoadLines:displayChunkLines()
    ...
    Display:drawLineCentered(0,relativePosY*13-8,Display.width,0,self.chunkLineColor,0,1)
end 

function LoadLines:displayGridLines()
    for i = 1,16 do Display:drawLine(i*16-8,0,0,Display.height, self.gridColor) end 
	for i = 1,16 do Display:drawLine(0,i*13-12,Display.width,0, self.gridColor) end
end 
